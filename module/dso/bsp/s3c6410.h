...
#define S3CFB_HRES					480    /* x方向分辨率*/
#define S3CFB_VRES					272    /* y方向分辨率*/
...
#define S3C_VIDTCON0_VBPD(x)		((x)<<16)
#define S3C_VIDTCON0_VFPD(x)		((x)<<8)
#define S3C_VIDTCON0_VSPW(x)		(x)

#define S3C_VIDTCON1_HBPD(x)		((x)<<16)
#define S3C_VIDTCON1_HFPD(x)		((x)<<8)
#define S3C_VIDTCON1_HSPW(x)		(x)

#define S3C_VIDTCON2_LINEVAL(x)		((x)<<11)
#define S3C_VIDTCON2_HOZVAL(x)		(x)

#define S3C_WINCONx_BPPMODE_F_16BPP_565			(0x5<<2)

#define	Lcd_enable()		S3C_VIDCON0 |= (S3C_VIDCON0_ENVID_ENABLE | S3C_VIDCON0_ENVID_F_ENABLE)		/* LCD ENABLE */
#define	Lcd_disable()		S3C_VIDCON0 &= (~(S3C_VIDCON0_ENVID_ENABLE | S3C_VIDCON0_ENVID_F_ENABLE))	/* LCD DISABLE */
#define	Lcd_panel_disable()	MIFPCON_REG |= SEL_BYPASS_MASK												/* LCD PANEL DISABLE */
...
#define S3C_VIDTCON0	   S3C_LCDREG(0x10)      /* Video Tcontrol 0 register */
#define S3C_VIDTCON1	   S3C_LCDREG(0x14)      /* Video Tcontrol 1 register */
#define S3C_VIDTCON2	   S3C_LCDREG(0x18)      /* Video Tcontrol 2 register */
...
#define S3C_VIDW00ADD2     S3C_LCDREG(0x100)     /* Video WINDOW 0 ADDRESS SIZE register */
